...
func TestDetectTranscodingFixtures(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want: Transcoding{Status: TranscodingSupported, RenderDevice: defaultRenderDevice, GroupID: 109},
		},
		{
			...
			want: Transcoding{Status: TranscodingMissing},
		},
		{
			...
			want: Transcoding{Status: TranscodingUnusable},
		},
		{
